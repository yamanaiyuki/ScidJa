...
menuText J OptionsMovesHighlightLastMoveDisplay "表示" 0 {最後の手をハイライト}
menuText J OptionsMovesHighlightLastMoveWidth "幅" 0 {線の太さ}
menuText J OptionsMovesHighlightLastMoveColor "色" 0 {線の色}
menuText J OptionsMovesHighlightLastMoveArrow "矢印を含める" 0 {ハイライトに矢印を含める}
...
translate J ShowSolution {解答を表示}
...
translate J MateFound {メイトが見つかりました}
translate J BestSolutionNotFound {最善答が見つかりません！}
translate J MateNotFound {メイトが見つかりません}
translate J ShorterMateExists {短いメイトが存在します}
translate J ScorePlayed {プレイしたスコア}
translate J Expected {期待値}
translate J ChooseTrainingBase {トレーニングベースを選択}
translate J Thinking {思考中}
translate J AnalyzeDone {分析完了}
translate J WinWonGame {勝利のゲーム}
...
set helpText(J,HardwareStatus) {<h1>外部ハードウェアのステータス</h1>
  ...
  <a HardwareConfig</a> ダイアログが開いています。
  ハードウェアを接続する前に設定を完了します。
  </li>
  </ul>
